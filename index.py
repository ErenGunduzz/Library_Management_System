...
class MainApp(QMainWindow, ui):
    ...
    def export_books(self):
        ...
        self.cur.execute(
            ''' SELECT id, book_name, book_desc, book_category,
    ...
    def export_users(self):
        ...
        wb = Workbook('all_users.xlsx')
        sheet1 = wb.add_worksheet()

        sheet1.write(0, 0, 'User Name')
        sheet1.write(0, 1, 'User Email')
        sheet1.write(0, 2, 'User Password')
        ...
        wb.close()
        self.statusBar().showMessage('User Report Created Successfully')
